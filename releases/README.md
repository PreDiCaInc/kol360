...
|---|---|---|
| [4.1.17](prod-rel-4.1.17-handoff.md) | v1.17.34 | Three HCP admin-page polish items: full-name search fix ("Paul Karpecki" returned 0 rows), NPI editable for PLATFORM_ADMIN with audit trail (`hcp.npi_changed`) + 409 on collision, email-placeholder converted from inline link to obvious chip button |
