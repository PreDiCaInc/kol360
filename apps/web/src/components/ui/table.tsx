...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-muted/30 [&_tr]:border-b [&_tr]:border-border/60', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border/40 transition-colors duration-150 hover:bg-muted/40 data-[state=selected]:bg-primary/5',
      className
    )}
    {...props}
  />
