...
export function StateBarChart({ data }: StateBarChartProps) {
  ...
  // in the chart view. (Table view uses its own 50-row cap via the
  ...
  // Adapt to the shared ChartTableToggle data shape ({ name, value }).
  // Hook called unconditionally — must precede any early return below.
  ...
  return (
    <ChartTableToggle data={tableData} valueLabel="Count">
